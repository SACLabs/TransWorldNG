...
def load_hddata(out_dir,training_step,pred_step):
...
def load_model_result(train_data_dir,out_dir,training_step,pred_step):
...
def unscale_feat(feat_dict, scalers):
    ...
    #scale_veh_col = ['height','width','x','xAcceleration','xVelocity','y','yAcceleration','yVelocity']
    #scale_lane_col = ['speed_avg','width','x','y']
...
# def unscale_feat_tau(feat_dict, scalers):
#     """
#     Unscale the scaled features in sim_feat using the corresponding scalers.
...
#     sim_feat (dict): the updated dictionary with unscaled features
#     """
#     scale_veh_col = ['acceleration','coor_x','coor_y','headway','length','pos_on_lane','speed','tlc_state','vmax']
#     scale_lane_col = ['length','occupancy','shape_a','shape_b','shape_c','shape_d','vehicles']
